...
public class EnderHopperScreenHandler extends ScreenHandler {
   private final Inventory inventory;

   public EnderHopperScreenHandler(int syncId, PlayerInventory playerInventory) {
      this(syncId, playerInventory, new SimpleInventory(5));
   }

   public EnderHopperScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
